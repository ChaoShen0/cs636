...
def training_loop(
    ...
    while cur_nimg < total_kimg * 1000:
        ...
        print(sched.tick_kimg * 10 + tick_start_nimg)
        # if cur_nimg >= tick_start_nimg + sched.tick_kimg * 1000 or done:
        if cur_nimg >= tick_start_nimg + sched.tick_kimg * 10 or done:
            cur_tick += 1
            # tick_kimg = (cur_nimg - tick_start_nimg) / 1000.0
            tick_kimg = (cur_nimg - tick_start_nimg) / 10.0
            tick_start_nimg = cur_nimg
            ...
            print('tick %-5d kimg %-8.1f lod %-5.2f minibatch %-4d time %-12s sec/tick %-7.1f sec/kimg %-7.2f maintenance %-6.1f gpumem %-4.1f' % (
                ...
                autosummary('Progress/kimg', cur_nimg / 10.0),
